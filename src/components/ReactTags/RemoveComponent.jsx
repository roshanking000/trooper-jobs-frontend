...
const RemoveComponent = (props) => {
  const { readOnly, removeComponent, onRemove, className, tag, index, removeIcon } = props;
  ...
  return (
    <button
      ...
      type="button"
      aria-label={ariaLabel}>
      {(removeIcon == null || removeIcon == undefined) && (crossStr)}
      {(removeIcon != null || removeIcon != undefined) && (
        <img
          src={removeIcon}
        ></img>
      )}
